const rows = [
  ...
  },
  {
    ...
    traditional: "None",
    mlBased: "Post-hoc",
    credence: "Per-decision factor breakdown",
  },
  {
    capability: "Rejection guidance",
    traditional: "Generic letter",
    mlBased: "None",
    credence: "Actionable improvement paths",
  },
  {
    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="mt-6 text-xs text-white/25 max-w-lg leading-relaxed">
          Credence is the first AI agent to handle end-to-end credit assessment for underbanked populations — composing scoring, explanation, and improvement guidance in a single natural-language interface.
        </p>
      </div>
          </div>
    </section>
